...
import {
  ...
  mergeTheme,
  safeIdentifier,
} from '../dist/packages/codegen/src/index.js';
...
test('mergeTheme merges nested motion durations', () => {
  const merged = mergeTheme(makeThemeTokens(), {
...
test("target 'static' emits index.html + main module with SEO meta and SSR shell", () => {
  ...
  assert.match(html.source, /--color-accent: #ff0055/);

...
test("target 'static' emits index.html + main module with SEO meta and SSR shell", () => {
  ...
  // Hydration manifest is stamped with the SceneIR schema version.
  assert.equal(res.hydrationManifest.irVersion, SCENE_IR_VERSION);
  assert.equal(JSON.parse(manifest.source).irVersion, SCENE_IR_VERSION);
});
